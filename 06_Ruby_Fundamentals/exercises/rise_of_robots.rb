...
class Robot #creates a class

  #creates getter and setter methods for each attribute specified (name, type, origin)
  attr_accessor :name, :type, :origin

    #this method creates new instances of the Robot class -- a constructor!
    #@instance_variables are available throughout the class
    def initialize(name, type, origin) #this is a constructor - a factory that creates new robots
